    ...
    <div className="flex gap-6 p-6 max-w-5xl mx-auto">
      ...
      <div className="w-full">
        <div className="w-[407px] h-[407px] ">
          <img
            src={productData.images} // Lấy hình ảnh từ trường `image`
      ...
      <div className="flex-1">
        ...
        <p className="text-sm text-gray-500">
          Loại: {productData.category} | Mã SP: {productData.id}
        </p>
        <div className="mt-4">
        ...
        <div className="mt-4">
          ...
          <div className="flex gap-2 mt-2">
            {productData.sizes.map((size, index) => (
              <button
                key={index}
                className="px-4 py-2 border border-gray-300 hover:border-red-500"
              >
                {size}
              </button>
            ))}
